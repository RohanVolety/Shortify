...
//   return (
//     <div className="h-16 bg-gray-900 z-50 flex items-center sticky top-0">
...
//           }  transition-all duration-100 sm:h-fit sm:bg-none bg-gray-900 sm:w-fit w-full sm:flex-row flex-col px-4 sm:px-0`}
//         >
  ...
  return (
    <div className="h-16 bg-gray-900 z-50 flex items-center sticky top-0">
      <div className="lg:px-14 sm:px-8 px-4 w-full flex justify-between">
        ...
        >
          <li className="hover:text-white font-[500] transition-all duration-150">
            <Link
              className={`${
                path === "/" ? "text-white font-semibold" : "text-gray-200"
              }`}
          ...
          {!token && (
            <Link to="/register">
              <li className="sm:ml-0 -ml-1 text-white cursor-pointer font-semibold transition-all duration-150 hover:text-white">
                SignUp
              </li>
            </Link>
          )}
          ...
          {token && (
            <button
              onClick={onLogOutHandler}
              className="sm:ml-0 -ml-1 text-white cursor-pointer font-semibold transition-all duration-150 hover:text-white"
            >
              LogOut
            </button>
          )}
